...
public class GestionPlanificationVol {
		    	...
		    	do
			    {
			    	...
			    	while(resultat1.next())
			    	{
			    		System.out.println(	  resultat1.getString(1) + "\t\t" + resultat1.getString(2) + "\t" 
			    							...
			    							+ resultat1.getString(9) + "\t\t\t" + resultat1.getString(10));
			    	...
			    	switch (choix)
			    	{
			    		case 1: //----------------------------------------------------------------------------------------------------------------------------------------
			    			...
			    			{	// SUPPRESSION DE VOL  a modifier avec la fonctionalite de SUPRESSION de la question 3
			    				System.out.println("Saisir " + numV + "pour supprimer le vol : ");
			    				SupprimerVol(conn);
			    			}
			    		...
			    		case 3: // --------------------------------------------------------------------------------------------------------------------------------------
			    			...
			    			System.out.println("6.\tPrix de base");
			    			System.out.println("7.\tVille");
			    			System.out.println("8.\tDestination");
			    			...
			    			switch (choix3)
			    			{
			    				...
			    				case 6:
			    					int prix = LectureClavier.lireEntier("Saisir le nouveau prix de base : ");
			    					
			    					nb3 = requete6.executeUpdate
			    							(
			    									"UPDATE vol "
			    									+ "SET prix_base_vol = " + prix 
			    									+ " WHERE numero_vol = " + numV 
	    									);
		...
		//Requete 4
		public static void TerminaisonVol(Connection conn) {
			try 
			{
		    	int choix = 1;
		    	do
			    {
			    	...
			    	int nb = requete2.executeUpdate
			    			( 
			    					"UPDATE vol SET etat_vol = 'arrive' "
			    					+ "WHERE numero_vol = " + numV
